...
<head>
    ...
    <link href="{{asset('users/css/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('users/css/owl.transitions.css')}}" rel="stylesheet">
    ...
    @if (App::getLocale() == 'ar')
        <link href="{{asset('users/css/navStyle.css')}}" rel="stylesheet">         
    @endif
</head>
<!--/head-->
...
<body id="home" class="homepage">
    ...
    <script>
        setTimeout(() => {
            document.getElementById("contactFormMsg").classList.add("smoothHide");
            setTimeout(() => {
                document.getElementById("contactFormMsg").style.display = "none";
            }, 3000)
        }, 9000);
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{asset('users/images/logo.png')}}" alt="logo"></a>
                    {{-- <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="Dropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('lang', 'en')}}"><i class="flag-united-kingdom flag"></i>English <i class="fa fa-check text-success ms-2"></i></a>
                            </li>
                            <li><hr class="dropdown-divider" /></li>
                            <li>
                                <a class="dropdown-item" href="{{ route('lang', 'fr')}}"><i class="flag-france flag"></i>Francais</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('lang', 'ar')}}"><i class="flag-egyptflag"></i>العربية</a>
                            </li>
                        </ul>
                    </div> --}}
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav" style="float: right;">
                        ...
                        <li class="scroll"><a href="{{ route('lang', 'en')}}">English</a></li>
                        <li class="scroll"><a href="{{ route('lang', 'fr')}}">Francais</a></li>
                        <li class="scroll"><a href="{{ route('lang', 'ar')}}">العربية</a></li>

                        {{-- <li class="scroll">{{ App::getLocale() }}</li> --}}
                    </ul>
                </div>
    ...
    <section id="main-slider" style="direction: ltr">
        <div class="owl-carousel">
            @foreach ($mainBanner as $oneMainBanner)
                ...
                @php
                    $mainBannerTitle = $oneMainBanner->{"title_{$locale}"};
                    $mainBannerDescription = $oneMainBanner->{"description_{$locale}"};
                @endphp
                
                <div class="item" style=" background-image: url({{asset('mainBanner/'.$oneMainBanner->photo)}});">
                    <div class="slider-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="carousel-content">
                                            <h2>{{ $mainBannerTitle}}</h2>
                                            <p>{{ $mainBannerDescription}}</p>
            ...
            @endforeach
            <!--/.item-->
            {{-- <div class="item" style="background-image: url({{asset('users/images/slider/bg2.jpg')}});">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
    ...
    <section id="cta" class="wow fadeIn">
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    <h2>{{ __('messages.template') }}</h2>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.
                    </p>
                </div>
                <div class="col-sm-3 text-right">
                    <a class="btn btn-primary btn-lg" href="#">{{ __('messages.download') }}</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.features') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="{{asset('users/images/main-feature.png')}}" alt="">
                </div>
                <div class="col-sm-6">
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>MULTI</span> {{ __('messages.template2') }}</h2>
                ...
                <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms"><a class="btn btn-primary btn-lg" href="#">{{ __('messages.download2') }}</a></p>
    ...
    <section id="services">
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.services') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.portfolio') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
            ...
            <div class="text-center">
                <ul class="portfolio-filter">
                    ...
                    @foreach ($ourWorkCats as $oneCat)
                        <li><a href="#" data-filter=".{{$oneCat->categoryName}}">{{$oneCat->categoryName}}</a></li>
                    @endforeach
            ...
            <div class="portfolio-items">
                ...
                @foreach ($ourWork as $oneProject)
                    @php
                        $projectPhoto = "users/images/portfolio/" . $oneProject->photo;
                    @endphp
                    <div class="portfolio-item {{$oneProject->categories}}">
                        <div class="portfolio-item-inner">
                            <img class="img-responsive" src="{{asset($projectPhoto)}}" alt="">
                            <div class="portfolio-info">
                                <h3>{{$oneProject->title}}</h3>
                                {{$oneProject->description}}
                                <a class="preview" href="{{asset($projectPhoto)}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                {{-- <div class="portfolio-item corporate portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('users/images/portfolio/02.jpg')}}" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 2</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="{{asset('users/images/portfolio/full.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div>
                <!--/.portfolio-item-->
                ...
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('users/images/portfolio/03.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('users/images/portfolio/04.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('users/images/portfolio/05.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('users/images/portfolio/06.jpg')}}" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 5</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="{{asset('users/images/portfolio/full.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('users/images/portfolio/07.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('users/images/portfolio/08.jpg')}}" alt="">
                        <div class="portfolio-info">
    ...
    <section id="about">
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.about') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
    ...
    <section id="work-process">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.process') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
    ...
    <section id="meet-team">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.team') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
    ...
    <section id="animated-number">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.facts') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
    ...
    <section id="pricing">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.pricing') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
    ...
    <section id="blog">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.blog') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
            ...
            <div class="row">
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img class="img-responsive" src="{{asset('users/images/blog/01.jpg')}}" alt="">
                ...
                <div class="col-sm-6">
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="{{asset('users/images/blog/02.jpg')}}" alt="">
                    ...
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="{{asset('users/images/blog/03.jpg')}}" alt="">
    ...
    <section id="get-in-touch">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">{{ __('messages.touch') }}</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
        </div>
    </section>
    ...
    <section id="contact">
        <div id="google-map1" style="height:650px" data-latitude="52.365629" data-longitude="4.871331"></div>
                    ...
                    <div class="col-md-4 col-md-offset-8 col-sm-6 col-sm-offset-6">
                        <div class="contact-form">
                            ...
                            <form method="post" action="{{route('contactForm.store')}}">
                                ...
                                <button type="submit" class="btn btn-primary">{{ __('messages.message') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('users/js/mousescroll.js')}}"></script>
    <script src="{{asset('users/js/smoothscroll.js')}}"></script>
    <script src="{{asset('users/js/jquery.prettyPhoto.js')}}"></script>
    <script src="{{asset('users/js/jquery.isotope.min.js')}}"></script>
    <script src="{{asset('users/js/jquery.inview.min.js')}}"></script>
